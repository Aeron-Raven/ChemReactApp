...
const AdminUsers = () => {
  ...
  return (
    <div className="admin-users">
      <button className="button is-success" onClick={handleAddUserModal}>
        Add User
      </button>
                ...
                <tr key={index} className="is-clickable">
                  ...
                  <td className="has-text-right">
                    <button
                      ...
                      onClick={() => handleEditUserModal(eachUser)}
                    >
                      Edit User
                    </button>
                    <button
                      className="button is-danger"
                      onClick={() => handleDeleteUserModal(eachUser)}
                    >
                      Remove User
                    </button>
                  </td>
        ...
        <Modal
          ...
          footer={
            <div className="modal-card-foot">
              <button className="button" onClick={() => setAddUserModal(false)}>
                Cancel
              </button>
            </div>
          }
