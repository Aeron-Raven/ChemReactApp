    ...
    <div className="home-page">
      <div className="headimage">
        ...
        <div className="starthide headtext fade-animate">
          ...
          <p>
            The importance of Chemistry Tools, with the power of Augmented
            Reality
          </p>
        </div>
      </div>
      ...
      <section className="page-body">
        <div className="box-wrapper">
          <div className="box-container-1">
            ...
            <p>
              Understand how chemistry tools work with the power of Augmented
              Reality Technology
            </p>
          </div>
        ...
        <div className="box-wrapper">
          ...
          <div className="box-container-1">
            ...
            <p>
              To better help understand how Chemistry tools work, without
              needing to buy them, making it cost efficient for both students
              and teachers of Pampanga High School !!
            </p>
          </div>
        </div>
        <div id="downloadnow"></div>
        <div
          className="box-wrapper about-us"
          style={{ flexDirection: "column", textAlign: "center" }}
        >
          <h1 className="title is-3">About us</h1>
          <div className="box behind">
            <p>
              We are the IT-69 of the Bachelor of Science in Information
              Technology of Don Honorio State Ventura University
            </p>
            <p>
              This was made for the purpose of helping the students learn while
        ...
        <div
          className="box-wrapper download"
          style={{ flexDirection: "column", textAlign: "center" }}
        >
