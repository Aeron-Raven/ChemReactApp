    ...
    <nav className="navbar fade-animate">
      ...
      <div className="menu-container">
        ...
        <a
          href="#aboutus"
          className="menu-link"
          onClick={(e) => handleAnchorClick(e, "aboutus")}
        >
          About us
        </a>
      </div>
      <div className="navbtn-container">
        <a
          ...
          onClick={(e) => handleAnchorClick(e, "downloadnow")}
        >
          Download
        </a>
        {!user && (
        ...
        {user && user.userfield === "admin" && (
          <div className="nav-user-container">
            <Link to="/admin" className="button is-black" tabIndex="0">
              Admin
            </Link>
        ...
        {user && user.userfield !== "admin" && (
          <div className="nav-user-container">
            <Link to="/student" className="button is-black" tabIndex="0">
              My Dashboard
            </Link>
            <button className="button" onClick={modalOpen}>
              Logout
        ...
        <div className="modal-card">
          ...
          <footer className="modal-card-foot is-right">
            <div className="buttons">
              ...
              <button className="button is-danger" onClick={modalClose}>
                Cancel
              </button>
            </div>
          </footer>
