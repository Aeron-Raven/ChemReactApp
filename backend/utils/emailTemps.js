const PASS_EMAIL_TEMP = `<!-- Change values in the template and pass { {variables} } with API call -->
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Best regards, <br><strong>Pampanga High School</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <tr>
                <td style="padding: 24px 0 48px; font-size: 0px;">
                  ...
                  <div class="outlook-group-fix" style="padding: 0 0 20px 0; vertical-align: top; display: inline-block; text-align: center; width:100%;">
                    <span style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">Pampanga National High School<br/>San Fernando, 2000 Pampanga</span>
                  </div>
...
const PASS_RESET_SUCCESS_TEMP = `<!-- Change values in the template and pass { {variables} } with API call -->
<!-- Feel free to adjust it to your needs and delete all these comments-->
<!-- Also adapt TXT version of this email -->
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <td class="main-content" style="padding: 48px 30px 40px; color: #000000;" bgcolor="#ffffff">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          This email was sent to inform you of your successful password reset! <span style="color: #4C83EE;">{{user_email}}</span>.
                        </td>
                      </tr>
                      <tr>
                      </tr>
                      ...
                      <tr>
                        <td style="padding: 0 0 60px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          If you didn’t request the password reset, please contact our support immediately <a href="mailto:support_email">support_email</a>.
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 16px;">
...
module.exports = { PASS_EMAIL_TEMP, PASS_RESET_SUCCESS_TEMP };